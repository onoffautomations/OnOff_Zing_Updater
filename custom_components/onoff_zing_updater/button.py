"""Button platform for OnOff Zing Updater."""
...
async def async_setup_entry(
    ...
    """Set up OnOff Zing Updater buttons."""
...
class PackageUpdateButton(ButtonEntity):
    ...
    def device_info(self) -> DeviceInfo:
        ...
        return DeviceInfo(
            ...
            manufacturer="OnOff Zing Updater",
    ...
    async def async_press(self) -> None:
        ...
        try:
            from . import async_install_package

            await async_install_package(
                self.hass,
            ...
            await self.hass.services.async_call(
                ...
                "create",
                {
                    "title": "OnOff Zing Updater - Update Complete",
                    "message": f"Updated **{repo_name}** successfully.",
                    "notification_id": f"onoff_update_{self._package_id}"
                },
                blocking=False
            )
            ...
            await self.hass.services.async_call(
                ...
                "create",
                {
                    "title": "OnOff Zing Updater - Update Failed",
                    "message": f"Failed to update **{repo_name}**\n\nError: {str(e)}",
                    "notification_id": f"onoff_update_error_{self._package_id}"
                },
                blocking=False
            )
